    ...
    public static class Parser
    {
        ...
        private static int SearchForObject(int oidx, int aidx, int rm, int cn, int ad, int spcobj, Game game)
        {
            ...
            for (i = 1; i <= i__1; ++i)
            {
                ...
                {
                    // !SEARCH OBJECTS.
                    if ((game.Objects.oflag1[j - 1] & ObjectFlags.VISIBT) == 0
        ...
        private static int ParseStart(int[] lbuf, int llnt, bool vbflag, Game game)
        {
            ...
            for (i = 1; i <= i__1; i += 2)
            {
                ...
                L75:
                if (game.pv_1.act != 0
                    && (ParserConstants.Verbs[game.pv_1.act - 1] != r50wal
                    || prep != 0))
                {
                    goto L200;
                }
        ...
        public static bool vappli_(string input, int ri, Game game)
        {
            ...
            // !OBJ HANDLE?
            if ((game.Rooms.Flags[game.Player.Here - 1] & RoomFlags.LAND) != 0)
            {
                goto L52200;
            }
            ...
            // !ANY OBJ SPECIFIED?
            if ((game.Rooms.Flags[game.Player.Here - 1] & (int)RoomFlags.WATER + RoomFlags.RFILL) != 0)
            {
                goto L56025;
            }
            ...
            L77000:
            if ((game.Rooms.Flags[(int)RoomIndices.tstrs - 1] & RoomFlags.SEEN) == 0)
            {
                goto L77100;
            }
      ...
      "NONE", "NOWHER" };
            ...
            L67000:
            i__1 = game.Rooms.Descriptions2[game.Player.Here - 1];
...
//            game.WriteOutputLine("V%1d.%1d%c\n", vers_1.vmaj, vers_1.vmin, vers_1.vedit);
            ...
            game.Exits.Travel[game.Rooms.Exits[game.Player.Here - 1]] = 214;
            // !CHANGE EXIT STATUS.
            return ret_val;
            ...
            game.Exits.Travel[game.Rooms.Exits[game.Player.Here - 1]] = 217;
            // !CHANGE EXIT STATUS.
            return ret_val;
